---
title: "Bayesian_lab3"
author: "Akshath Srinivas (akssr921),Yaning Wang (yanwa579)"
output: pdf_document
...
Now we should to check if they are convergence. We will check it below.
The values we simulate from the actual posterior of beta using the Metropolis algorithm has 9 dimensions, we randomly use the first and second dimension(to save place here) to check.
